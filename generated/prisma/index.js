...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/alexi/Proyectos/spazios/consorcios-app-lovable/consorcio-hub-connect/backend/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/alexi/Proyectos/spazios/consorcios-app-lovable/consorcio-hub-connect/backend/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://admin:admin123@localhost:5433/consorcio_hub"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nenum UserRole {\n  SUPER_ADMIN\n  BUILDING_ADMIN\n  OWNER\n  SERVICE_PROVIDER\n}\n\nmodel User {\n  id        String   @id @default(uuid())\n  email     String   @unique\n  password  String\n  firstName String\n  lastName  String\n  role      UserRole\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  // Relaciones que se implementarán más adelante\n  // buildings     Building[]\n  // units         Unit[]\n  // serviceProvider ServiceProvider?\n\n  @@map(\"users\")\n}\n",
  "inlineSchemaHash": "a84c2a81c064bd59efc551e3981e7e96d468c964fd6b403bbec8aae780c7c4b9",
  "copyEngine": true
}
